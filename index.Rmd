...
<p>
<i class="fas fa-map-marker-alt fa-1x" style="color:dodgerblue"></i> Institut Agro - Agrocampus Ouest
...
<i class="fas fa-envelope fa-1x" style="color:dodgerblue"></i> david [dot] causeur [at] agrocampus-ouest [dot] fr 
