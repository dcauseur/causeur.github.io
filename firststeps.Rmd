...
* [Video lecture](https://youtu.be/frs5pacwPYQ) with [slides](./teaching/PDFs/DS20Session4.pdf), [data](./teaching/data/pig.txt) and [R script](./teaching/scripts/session4.R);   
...
* [Video lecture](https://youtu.be/XJbWDBvC4cg) with [slides](./teaching/PDFs/DS20Session5.pdf), [data](./teaching/data/pig.txt) and [R script](./teaching/scripts/session5.R);   
