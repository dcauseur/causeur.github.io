...
* [Video lecture](https://youtu.be/5KLMYWWWcsE) with [slides](./teaching/PDFs/SLBDsession1.pdf), [R script](./teaching/scripts/SLBDsession1.R) and data ([1](./teaching/data/SLBDinvasive.txt) and [2](./teaching/data/SLBDcoffee.txt));   
...
* In-class activities: exercise and data (1 and 2).
